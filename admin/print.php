...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									else if($troom=="London")
									{
										$type_of_room = 10000;
									}
									else if($troom=="Maldives")
									{
										$type_of_room = 3000;
									}
									else if($troom=="Canada")
									{
										$type_of_room = 7500;
									}
									else if($troom=="USA")
	...
	?>
		<header>
			...
			<address >
				<p>BEST TRAVEL ANS,</p>
				<p>KIT-college<br>Kannampalayam<br>Coimbatore</p>
				<p>+91 6383163588</p>
			</address>
			<span><img alt="" src="assets/img/ANS.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span ><?php echo $bed; ?>  Spot</span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span data-prefix>RS</span><span ><?php  echo $type_of_room;?></span></td>
						<td><span ><?php echo $nroom;?> </span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- sarathybalan237@gmail.com || Web :- www.besttravelans.com || Phone :- +91 6383163588 </p>
			</div>
		</aside>
	</body>
</html>
